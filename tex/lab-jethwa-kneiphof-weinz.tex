...
Wir werden das Hamburger Moment Shadow Mapping nutzen, welches 4 Momente generiert und den Variance Shadow Maps ähnlich ist. Zum filtern nutzen wir MSAA und einen Gauss Filter. Die Implementierung war denkbar einfach, da wir bereits HLSL Code hatten, durch die Präsentation des Moment Shadow Mapping Papers\cite{msm}. Diesen haben wir für GLSL umgesetzt.
...
Mipmap-Filtertechniken auszuprobieren um diese Artefakte zu vermeiden. Wir experimentierten ebenfalls
mit einer Konvexkombination von Momenten, die aus verschiedenen Mipmap-Ebenen entnommen wurden. Hier haben
wir zwar in manchen Fällen die durch MipMap verursachten Artefakte reduzieren können, allerdings
ist hier noch weitere Arbeit notwendig um eine optimale Verteilung der Koeffizienten zur Gewichtung
der Mipmapebenen zu finden.
...
\begin{figure}[H]
	...
	\subfloat[MBVO Beispiel 1]{
		...
		\includegraphics[width = 6cm]{msm_assets/mbvo001.png}
		\label{ref:mbvo1}
	}
