...
Das Moment Shadow Mapping ist eine Technik, welche dem Variance Shadow Mapping ähnelt. Es benutzt 4 Momente, welche gefiltert werden können. Dadurch können z.B. Light-Leeking verhindert.Moment Shadow Mapping vereint möglichst viele positive Aspekte anderer Schattentechniken und bietet Schatten mit hoher Qualität ohne viel Performance einzubüßen.
...
Für das Moment Based Volumetric Obscurance benutzen wir die gleiche Herangehensweise. Allerdings hat es sich herausgestellt, dass die Transformation für 4 Momente zu Artefakten führt, da die numerische optimierung mit der Matrix, wie im MSM Paper beschrieben zu Artefakten führt.
