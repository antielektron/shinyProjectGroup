...
\begin{figure}
	...
	\caption{Visualisierung der Kaskaden in rot (nah), grün, blau, gelb (fern). (a) und (c) zeigen die Partitionierung durch Parallel Split Shadow Maps, optimiert für (a). (b) und (d) zeigen die Partitionierungen durch Sample Distribution Shadow Maps. Während Sample Distribution Shadow Maps die Kaskaden adaptiv anpassen können, versagen die Parallel Split Shadow Maps}
\end{figure}
