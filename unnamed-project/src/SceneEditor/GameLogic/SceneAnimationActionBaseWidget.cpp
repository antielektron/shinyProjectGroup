...
SceneAnimationActionBaseWidget::SceneAnimationActionBaseWidget(std::shared_ptr<SceneEditorGame> game, QWidget *parent) :
        QWidget(parent),
        m_game(game)
{
    generateWidgets();
...
SceneAnimationActionBaseWidget::~SceneAnimationActionBaseWidget()
{}

void SceneAnimationActionBaseWidget::generateWidgets()
{
...
void SceneAnimationActionBaseWidget::connectStuff()
{
...
void SceneAnimationActionBaseWidget::closeEvent(QCloseEvent *event)
{
    deleteLater();
